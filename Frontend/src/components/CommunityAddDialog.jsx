...
const CommunityAddDialog = ({ isOpen, onClose, setCommunities, setShowAlert, setAlertMessage, setAllCommunities }) => {
    ...
    const confirmAddDialog = async () => {
        ...
        try {
            const res = await axios.post(`${host}/communities/add`, formData, {
            ...
            setCommunities(prevItems => [...prevItems, createdCommunity]);
            setAllCommunities(prevItems => [...prevItems, createdCommunity]);

            setAlertMessage(`Community ${newGroup.community_name} created successfully`)
            setNewGroup({
                community_name: '',
                profile_img: '',
                community_description: '',
    ...
    return (
        <Dialog isOpen={ isOpen } onClose={ onClose }>
            <div className='flex flex-col justify-start items-start gap-4'>
                <h1 className='text-2xl'>Add community</h1>
...
export default CommunityAddDialog;
