...
const ArticleAddDialog = ({ isOpen, onClose, setArticles, setShowAlert, setAlertMessage, setAllArticles }) => {
    ...
    const confirmAddDialog = async () => {
        ...
        try {
            const res = await axios.post(`${host}/articles/add`, formData, {
            ...
            const createdArticle = res.data;
            console.log(res.data)
            setArticles(prevItems => [...prevItems, createdArticle]);
            setAllArticles(prevItems => [...prevItems, createdArticle]);
            setNewArticle({
                title: '',
                article_img: '',
                article_description: '',
            ...
            setAlertMessage(`Article ${newArticle.title} created successfully`)
            setShowAlert(true);
