...
function SignupForm({ host, blur, setShowConfMessage, setEmail, inputs, setInputs }) {
    ...
    return (
        <div className={` md:px-20 py-10 lg:px-0 xl:px-20 flex flex-col items-start justify-between ${blur ? "blur-sm" : null}`} >
            <div className='px-12 md:px-20  flex flex-row justify-start items-center gap-2 mb-5 lg:mb-10'>
