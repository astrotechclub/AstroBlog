                    ...
                    <div className="relative z-10 min-h-[100vh]">
                        ...
                        { screenSize === 'large' && <>
                            ...
                            <div className=" h-full w-full">
                                <img src={ article.img } alt="article" className="brightness-75 object-cover w-full h-full" />
                            </div>
                        </> }
                        ...
                        <div className="pl-8 lg:px-20 py-10 grid grid-cols-5 lg:flex  lg:flex-row items-start justify-between gap-4">
                            ...
                            <div className="col-span-2 flex justify-end translate-x-10">
                        ...
                        <div className="grid grid-cols-6 grid-rows-1 w-full mt-10 px-8 md:px-14 lg:px-20 gap-4">
                            ...
                            <div className="col-span-5 md:col-span-4">
                                ...
                                <h1 className="font-bold text-lg md:text-3xl">{ article.title }</h1>
